...
function enviarEmail(e) {
  ...
  setTimeout(() => {
    ...
    mensajeEnviado.textContent =
      "Su Consulta ha sido enviada satisfactoriamente!";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Aplica la clase 'move-image' después de un breve retraso (por ejemplo, 1 segundo)
  setTimeout(function () {
    imageContainer.classList.add("move-image");
